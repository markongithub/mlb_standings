...
def wildcard_standings(standings_immutable, divisions, wildcard_count, division_winners=1):
    contenders = set()
    ...
    df.loc[df.groupby('div').head(division_winners).index, 'first_place'] = True
